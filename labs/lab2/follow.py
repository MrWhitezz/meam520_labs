...
class JacobianDemo():
    ...
    def ellipse(t,f=1,rx=.10,ry=.20):
        ...
        xdes = JacobianDemo.x0 + np.array([-rx*cos(f*t) + rx,ry*sin(f*t),0])
    ...
    def line(t,f=0.1,L=.2):
        ...
        xdes = JacobianDemo.x0 + np.array([L*sin(2*pi*f*t),0,0])
